//
//  CustomTabBarAnimator.swift
//  Todododo
//
//  Created by Wismin Effendi on 9/3/17.
//  Copyright © 2017 Wismin Effendi. All rights reserved.
//

import UIKit

class SplitViewAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func interruptibleAnimator(using transitionContext: UIViewControllerContextTransitioning) -> UIViewImplicitlyAnimating {
        ...
        let ix1 = splitViewController.viewControllers.index(of: vc1)!
        let ix2 = splitViewController.viewControllers.index(of: vc2)!
